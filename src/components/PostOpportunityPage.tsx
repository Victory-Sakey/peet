  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 space-y-8">
      ...
      <div className="text-center space-y-3">
        ...
        <p className="text-zinc-500 dark:text-zinc-600 dark:text-zinc-600 dark:text-zinc-600 text-sm max-w-lg mx-auto">
      ...
      {step <= 5 && (
        ...
        <div className="glass-panel rounded-3xl p-4 sm:p-6 border border-purple-500/5 shadow-xl">
          <div className="flex justify-between items-center relative w-full px-2 sm:px-4">
            {/* Timeline Line */}
            <div className="absolute top-1/2 left-8 right-8 h-0.5 bg-zinc-100 dark:bg-zinc-100/60 dark:bg-zinc-800 -translate-y-1/2 z-0" />
            <div
                  ...
                  <div
                    className={`w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-xs font-bold transition-all duration-300 ${
                      active
                        ...
                        : completed
                        ? "bg-purple-950 text-purple-700 border border-purple-500/35"
                        : "bg-zinc-100 dark:bg-zinc-100 text-zinc-500 dark:text-zinc-600 border border-zinc-200"
                    }`}
                  >
                    {completed ? "✓" : idx + 1}
                  </div>
                  <div className="text-center hidden sm:block">
                    <div className={`text-[10px] sm:text-xs font-extrabold ${active ? "text-purple-600" : "text-zinc-600 dark:text-zinc-600"}`}>
                      {s.label}
                    </div>
                  </div>
                </div>
      ...
      <div className="glass-panel rounded-3xl p-4 sm:p-8 border border-purple-200/50 shadow-2xl space-y-6 min-h-[350px] flex flex-col justify-between">
        {step === 1 && (
          <div className="space-y-6 animate-fade-in flex-1">
            <div className="space-y-2">
              <h2 className="text-lg font-bold text-zinc-900">Select Opportunity Type</h2>
              <p className="text-xs text-zinc-500 dark:text-zinc-600">What type of listing are you posting today?</p>
            </div>
              ...
              {[
                {
                  ...
                  color: "border-purple-200/50 hover:border-purple-500/30 text-purple-600 bg-purple-500/5"
                },
                {
                  id: "education",
                  title: "Education",
                  ...
                  <button
                    ...
                    className={`p-5 rounded-2xl border text-left flex flex-col justify-between transition-all duration-300 group min-h-[140px] relative ${
                      isSelected
                        ...
                        : "bg-zinc-100/50 border-zinc-900 hover:bg-zinc-100 dark:bg-zinc-100/40"
                    }`}
                  >
                    {isSelected && (
                      <div className="absolute top-3 right-3 w-4 h-4 rounded-full bg-purple-600 text-white">
                        ✓
                      </div>
                    )}
                    <div className={`p-2.5 rounded-xl border w-fit ${isSelected ? "bg-purple-600/10 border-purple-200 text-purple-350" : opt.color}`}>
                      <Icon className="w-5 h-5" />
                    </div>
                    <div className="space-y-1 pt-3">
                      <div className="font-extrabold text-sm text-zinc-900">{opt.title}</div>
                      <div className="text-[10px] text-zinc-500 dark:text-zinc-600 group-hover:text-zinc-600 dark:text-zinc-600 transition-colors leading-relaxed">
                        {opt.desc}
                      </div>
                    </div>
                  </button>
            ...
            <div className="space-y-2 pt-2">
              <label className="text-xs font-extrabold text-zinc-500 block uppercase tracking-wider">Select Technical Field / Category</label>
                    ...
                    <button
                      ...
                      className={`flex items-center gap-3 p-3 rounded-xl border text-xs font-bold transition-all ${
                        isSelected
                          ...
                          : "bg-zinc-100 dark:bg-zinc-100/40 border-zinc-900 hover:border-purple-200/50 hover:bg-zinc-100 dark:bg-zinc-100/60 text-zinc-600 dark:text-zinc-600"
                      }`}
                    >
                      <Icon className={`w-4 h-4 ${isSelected ? "text-zinc-900 dark:text-white" : "text-purple-500"}`} />
                      <span>{cat}</span>
                    </button>
                  );
                })}
        ...
        {step === 2 && (
          <div className="space-y-6 animate-fade-in flex-1">
            <div className="space-y-2">
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-600">Provide details about the listing entity and title.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold text-zinc-600 dark:text-zinc-600 block uppercase">Opportunity Title</label>
                <input
                  type="text"
                  required
                  placeholder={
                  ...
                  className="w-full px-4 py-3 bg-zinc-100 dark:bg-zinc-100/60 rounded-xl border border-purple-200/50 focus:outline-none focus:ring-1 focus:ring-purple-600 focus:border-transparent text-xs text-zinc-800 transition-all"
                />
              </div>

              <div className="space-y-1.5">
                <label className="text-[10px] font-bold text-zinc-600 dark:text-zinc-600 block uppercase">Organization / Provider Name</label>
                <input
                  type="text"
                  required
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold text-zinc-600 dark:text-zinc-600 block uppercase">Office Location</label>
                <input
                  type="text"
                  required
              ...
              <div className="space-y-1.5 relative">
                <label className="text-[10px] font-bold text-zinc-600 dark:text-zinc-600 block uppercase">Sub-Type Format</label>
                <button
                  type="button"
                  onClick={() => setIsSubTypeDropdownOpen(!isSubTypeDropdownOpen)}
                  className="w-full px-4 py-3 bg-zinc-100 dark:bg-zinc-100/60 rounded-xl border border-purple-200/50 text-xs text-zinc-800 text-left flex items-center justify-between transition-all select-none cursor-pointer"
                >
                  <span>{oppSubType}</span>
                  <ChevronDown className={`w-4 h-4 text-zinc-600 dark:text-zinc-600 transition-transform ${isSubTypeDropdownOpen ? "rotate-180" : ""}`} />
                </button>
                      ...
                      {(oppType === "job"
                        ...
                        <button
                          ...
                          className={`w-full text-left px-3 py-2 text-xs font-semibold rounded-lg transition-colors ${
                            oppSubType === sub
                              ? "bg-purple-650 text-zinc-900 dark:text-white"
            ...
            <div className="space-y-1.5 relative">
              <label className="text-[10px] font-bold text-zinc-600 dark:text-zinc-600 block uppercase">Logo Visual Identifier</label>
              <button
                type="button"
              ...
              >
                ...
                <ChevronDown className={`w-4 h-4 text-zinc-600 dark:text-zinc-600 transition-transform ${isLogoDropdownOpen ? "rotate-180" : ""}`} />
              </button>
              {isLogoDropdownOpen && (
                <>
                  <div className="fixed inset-0 z-30" onClick={() => setIsLogoDropdownOpen(false)} />
                  <div className="absolute top-full left-0 right-0 mt-1 z-40 max-h-52 overflow-y-auto glass-panel rounded-xl p-1.5 border border-purple-200 shadow-xl scrollbar-thin scrollbar-thumb-zinc-800 scrollbar-track-transparent">
                    {logoOptions.map((opt) => (
                      <button
                        key={opt.value}
                        type="button"
        ...
        {step === 3 && (
          <div className="space-y-6 animate-fade-in flex-1">
            <div className="space-y-2">
              <h2 className="text-lg font-bold text-zinc-900">Financials & Criteria</h2>
              <p className="text-xs text-zinc-500 dark:text-zinc-600">Provide compensation details and filtering criteria tags.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold text-zinc-600 dark:text-zinc-600 block uppercase">
            ...
            {oppType !== "job" && (
              <div className="space-y-3 p-4 bg-zinc-100 dark:bg-zinc-100/40 rounded-2xl border border-purple-500/5">
                <div className="text-[10px] font-bold text-zinc-600 dark:text-zinc-600 uppercase tracking-wider mb-2">Program Attributes</div>
                
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <label className="flex items-center gap-2.5 cursor-pointer text-xs font-semibold text-zinc-600 dark:text-zinc-600 hover:text-zinc-800 select-none">
                    <input
                      type="checkbox"
                      checked={isFree}
                      onChange={(e) => setIsFree(e.target.checked)}
                      className="w-4 h-4 rounded border-purple-200/50 accent-purple-600 focus:ring-purple-600"
                    />
        ...
        {step === 4 && (
          <div className="space-y-6 animate-fade-in flex-1">
            <div className="space-y-2">
              <h2 className="text-lg font-bold text-zinc-900">Detailed Descriptions</h2>
              <p className="text-xs text-zinc-500 dark:text-zinc-600">Outline the target candidate profile and skills required.</p>
            </div>

            <div className="space-y-1.5">
              <label className="text-[10px] font-bold text-zinc-600 dark:text-zinc-600 block uppercase">Opportunity Description</label>
              <textarea
                rows={3}
                required
                ...
                className="w-full px-4 py-3 bg-zinc-100 dark:bg-zinc-100/60 rounded-xl border border-purple-200/50 focus:outline-none focus:ring-1 focus:ring-purple-600 focus:border-transparent text-xs text-zinc-800 resize-none transition-all"
              />
            </div>

            <div className="space-y-1.5">
              <label className="text-[10px] font-bold text-zinc-600 dark:text-zinc-600 block uppercase">Key Requirements (Semicolon separated ;)</label>
              <textarea
                rows={2}
                required
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] font-bold text-zinc-600 dark:text-zinc-600 block uppercase">Skills Required (Comma separated)</label>
              <input
                type="text"
                required
        ...
        {step === 5 && (
          <div className="space-y-6 animate-fade-in flex-1">
            <div className="space-y-2">
              <h2 className="text-lg font-bold text-zinc-900">Review Sandbox Posting</h2>
              <p className="text-xs text-zinc-500 dark:text-zinc-600">Confirm the layout matches your expectations before deploying to database.</p>
            </div>

            {/* Simulated Live Seeker Card Preview */}
            <div className="space-y-2">
              <div className="text-[10px] font-extrabold text-zinc-500 dark:text-zinc-600 uppercase tracking-widest pl-1">Live Preview Card</div>
              <div className="glass-panel rounded-2xl p-5 border border-purple-200 max-w-2xl flex flex-col sm:flex-row gap-5 items-start justify-between relative group select-none pointer-events-none">
                <div className="flex gap-4 items-start">
                  ...
                  <div className="space-y-1 flex-1">
                    ...
                    <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-xs text-zinc-600 dark:text-zinc-600">
                      <span className="font-semibold text-zinc-700 dark:text-purple-800">{provider || "Provider Name"}</span>
                      <span>•</span>
                    ...
                    <div className="flex flex-wrap gap-1.5 pt-2">
                      {(skillsText ? skillsText.split(",") : ["React", "CSS"]).slice(0, 4).map((skill) => (
                        <span
                          key={skill}
                          className="text-[10px] font-semibold px-2 py-0.5 rounded-md bg-zinc-800 text-zinc-700 dark:text-purple-800"
                        >
                          {skill.trim()}
                        </span>
                      ))}
                ...
                <div className="flex sm:flex-col items-center sm:items-end justify-between w-full sm:w-auto border-t sm:border-t-0 pt-3 sm:pt-0 border-purple-200/50 gap-2">
                  ...
                  <div className="text-right sm:block hidden mb-2">
                    <span className="text-xs text-zinc-500 dark:text-zinc-600 block font-medium">
                      {oppType === "job" ? "Compensation Range" : "Opportunity Cost"}
                    </span>
                    <span className="text-sm font-bold text-zinc-700 dark:text-purple-800">
                      {salaryOrCost || "Free"}
                    </span>
                  </div>
        ...
        {step === 6 && (
          <div className="py-8 text-center space-y-6 animate-scale-up flex-1 flex flex-col justify-center items-center">
            ...
            <div className="space-y-2 max-w-md mx-auto">
              <h2 className="text-2xl font-extrabold text-zinc-900">Published Successfully!</h2>
            ...
            <div className="flex flex-wrap gap-3 pt-4 justify-center">
              <button
                ...
                className="px-5 py-2.5 rounded-xl border border-zinc-200 text-xs font-bold text-zinc-600 dark:text-zinc-600 hover:text-zinc-800 transition-colors"
              >
                Post Another
              </button>
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-purple-600 text-white text-xs font-bold shadow-md shadow-purple-500/10 transition-all"
              >
        ...
        {step <= 5 && (
          ...
          <div className="flex justify-between items-center pt-6 border-t border-purple-200/50">
            <button
              type="button"
              onClick={handlePrevStep}
              disabled={step === 1}
              className={`flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-bold transition-all border border-zinc-200 text-zinc-600 dark:text-zinc-600 hover:text-zinc-800 ${
            ...
            {step === 5 ? (
              <button
                ...
                className="flex items-center gap-1.5 px-5 py-2.5 rounded-xl bg-purple-600 text-white text-xs font-bold transition-all shadow-md shadow-purple-500/15"
              >
