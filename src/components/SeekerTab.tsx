    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-64 shrink-0 space-y-6">
          {/* Profile Card */}
          <div className="flex items-center gap-3 p-4 bg-zinc-50/50 dark:bg-zinc-100 dark:bg-zinc-100/20 rounded-2xl border border-purple-500/5">
            <div className="w-12 h-12 rounded-full bg-gradient-to-tr from-purple-600 to-purple-400 flex items-center justify-center text-zinc-900 dark:text-white font-extrabold text-lg shadow-md shrink-0">
              {seekerName.charAt(0).toUpperCase()}
            </div>
            <div className="min-w-0">
              <h4 className="font-extrabold text-sm text-zinc-800 dark:text-zinc-800 truncate">
                {seekerName}
              </h4>
              <span className="text-[10px] text-zinc-500 dark:text-zinc-600 dark:text-zinc-600 dark:text-zinc-600 font-bold block uppercase tracking-wider">
                Opportunity Seeker
              </span>
            </div>
          </div>
          ...
          <nav className="flex flex-row md:flex-col gap-1 overflow-x-auto pb-2 md:pb-0 scrollbar-none border-b border-zinc-200 dark:border-zinc-200/80 md:border-b-0">
            {[
              ...
              return (
                <button
                  ...
                  className={`flex items-center justify-between px-4 py-3 rounded-xl text-xs sm:text-sm font-bold transition-all shrink-0 cursor-pointer md:w-full text-left ${
                    isActive
                      ? "bg-purple-600/10 text-purple-600 dark:text-purple-700 border-b-2 md:border-b-0 md:border-l-4 border-purple-600"
                      : "text-zinc-500 dark:text-zinc-600 hover:text-purple-600 dark:hover:text-purple-700 hover:bg-zinc-100/50 dark:hover:bg-zinc-100 dark:bg-zinc-100/40"
                  }`}
                >
                  ...
                  {isActive && <span className="hidden md:inline text-purple-600 dark:text-purple-700 font-bold">&gt;</span>}
                </button>
              );
            })}
          </nav>
        ...
        <div className="flex-grow min-w-0">
            ...
            <div className="space-y-6 animate-fade-in">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 relative overflow-hidden glass-panel rounded-3xl p-6 flex flex-col items-center justify-center border border-purple-500/5 h-full">
                  ...
                  <div className="relative flex items-center justify-center my-4">
                    ...
                    <div className="absolute flex flex-col items-center justify-center">
                      <span className="text-4xl font-extrabold text-zinc-800 dark:text-zinc-900 dark:text-white">78</span>
                      <span className="text-[10px] font-bold text-zinc-500 dark:text-zinc-600 uppercase tracking-widest mt-0.5">
                        Score
                      </span>
                    </div>
                  </div>
                  
                  <p className="text-xs text-zinc-550 dark:text-zinc-600 dark:text-zinc-600 text-center max-w-sm mt-6 font-semibold leading-relaxed">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="bg-gradient-to-br from-amber-500 via-orange-500 to-orange-600 rounded-3xl p-6 flex items-center gap-5 text-zinc-900 dark:text-white shadow-lg shadow-orange-500/15">
                    <div className="w-14 h-14 bg-white/20 backdrop-blur-md rounded-2xl flex items-center justify-center shrink-0">
                      <Flame className="w-7 h-7 text-zinc-900 dark:text-white fill-white" />
                    </div>
                    <div>
                      <span className="text-[10px] font-bold text-zinc-900 dark:text-white/80 uppercase tracking-wider block mb-0.5">
                        Activity Streak
                      </span>
                      <span className="text-3xl font-extrabold text-zinc-900 dark:text-white">14 Days</span>
                    </div>
                  </div>

                  {/* Daily Motivation Card */}
                  <div className="glass-panel rounded-3xl p-6 border border-purple-500/5 bg-white dark:bg-zinc-100 dark:bg-zinc-100/40 space-y-4 flex flex-col justify-center flex-1">
                    <span className="text-[10px] font-bold text-purple-600/70 dark:text-purple-700/70 uppercase tracking-wider block">
                      Daily Motivation
                    </span>
                    <blockquote className="text-sm font-semibold text-zinc-800 dark:text-zinc-800 leading-relaxed italic">
                      "{quote.text}"
                    </blockquote>
                    <cite className="text-xs text-zinc-500 dark:text-zinc-600 dark:text-zinc-600 dark:text-zinc-600 font-bold block not-italic">
                      — {quote.author}
                    </cite>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="glass-panel rounded-3xl p-5 border border-purple-500/5 flex items-center gap-4 hover:border-purple-200/50 transition-colors">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-zinc-550 dark:text-zinc-600 dark:text-zinc-600 font-bold">
                ...
                <div className="glass-panel rounded-3xl p-5 border border-purple-500/5 flex items-center gap-4 hover:border-purple-200/50 transition-colors">
                  <div className="w-12 h-12 bg-purple-500/10 dark:bg-purple-950/40 rounded-2xl flex items-center justify-center text-purple-600 dark:text-purple-600 shrink-0">
          ...
          {activeTab === "opportunities" && (
            <div className="space-y-6 animate-fade-in">
              <div className="flex border-b border-purple-200/50 gap-2 pb-px justify-center md:justify-start">
                {[
          ...
          {activeTab === "goals" && (
            <div className="glass-panel rounded-3xl p-6 border border-purple-500/5 space-y-6 animate-fade-in">
              <div className="space-y-2">
                ...
                <p className="text-xs text-zinc-550 dark:text-zinc-600 dark:text-zinc-600 leading-relaxed">
                  Establish targets, track your tasks, and watch your Life Momentum score rise as you achieve milestones.
                </p>
              </div>

              {/* Progress Bar */}
              <div className="space-y-2 bg-zinc-50 dark:bg-zinc-100 dark:bg-zinc-100/40 p-4 rounded-2xl border border-purple-500/5">
                <div className="flex justify-between items-center text-xs font-bold text-zinc-700 dark:text-zinc-700 dark:text-purple-800">
              ...
              <form onSubmit={handleAddGoal} className="flex gap-2">
                <input
                  ...
                  className="flex-grow px-4 py-2.5 bg-zinc-50 dark:bg-zinc-100 dark:bg-zinc-100/60 rounded-xl border border-zinc-200 dark:border-purple-200/50 focus:outline-none focus:ring-1 focus:ring-purple-600 text-xs text-zinc-700 dark:text-zinc-800"
                />
                <button
                  type="submit"
                  className="px-4 py-2.5 bg-purple-600 text-white rounded-xl text-xs font-bold transition-all shrink-0 flex items-center gap-1 cursor-pointer shadow-md shadow-purple-500/10"
                >
              ...
              <div className="space-y-2.5 max-h-[350px] overflow-y-auto pr-1">
                {goals.length === 0 ? (
                  <div className="text-center py-10 text-xs text-zinc-500 dark:text-zinc-600 italic">
                  ...
                  goals.map((goal) => (
                    <div
                      key={goal.id}
                      className="flex items-center justify-between p-3.5 bg-zinc-50/50 dark:bg-zinc-100 dark:bg-zinc-100/10 rounded-xl border border-purple-500/5 transition-all hover:border-purple-200/50"
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <span
                          className={`text-xs font-semibold truncate transition-all ${
                            goal.completed
                              ? "line-through text-zinc-600 dark:text-zinc-600 dark:text-zinc-550"
                              : "text-zinc-750 dark:text-zinc-800"
                          }`}
                        >
                          {goal.text}
                        </span>
                      ...
                      <button
                        ...
                        className="p-1.5 text-zinc-600 dark:text-zinc-600 hover:text-red-500 rounded-lg hover:bg-red-500/5 transition-all cursor-pointer shrink-0"
                      >
